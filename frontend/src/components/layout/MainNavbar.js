        ...
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="section-1">
            <div className="container-fluid">
                <a href="/" className="navbar-brand">
                    <img
                        src="/Images/logo-transparent-2.png"
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul className="navbar-nav text-larger">
                        ...
                        <li className="nav-item dropdown">
                            <a href="/" className="nav-link dropdown-toggle disabled" id="navbardrop-news" data-bs-toggle="dropdown">Synth News</a>
                        ...
                        <li className="nav-item dropdown">
                            <a href="/" className="nav-link dropdown-toggle" id="navbardrop-contact" data-bs-toggle="dropdown">Contact</a>
                            <div className="dropdown-menu bg-transparent">
